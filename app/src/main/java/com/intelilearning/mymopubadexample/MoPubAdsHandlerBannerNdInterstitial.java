...
public class MoPubAdsHandlerBannerNdInterstitial implements MoPubInterstitial.InterstitialAdListener {
    ...
    public MoPubAdsHandlerBannerNdInterstitial(Context context, String requestingActivity) {
        mContext = context;
    ...
    public void handleBannerAds(){
        if (sActivity.equals(AddCheck.MySourceActivity)){
            ...
            if (MyConstants.hasAd && doNotSkipAd) {
                ...
                moPubView = (MoPubView) activity.findViewById(R.id.mainActivityBanner);
                if (adsInitializationCompleted){
    ...
    private SdkInitializationListener initSdkListener() {
	   ...
	   Check if you should show the consent dialog here, and make your ad requests. */
                ...
                if (loadInterstitialOnInitializationComplete){
                    mInterstitial = new MoPubInterstitial((Activity) mContext, MyConstants.myMainActivityInterstitialID);
                    mInterstitial.setInterstitialAdListener(MoPubAdsHandlerBannerNdInterstitial.this);
                    mInterstitial.load();
